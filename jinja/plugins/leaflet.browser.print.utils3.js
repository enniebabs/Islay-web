...
L.Control.BrowserPrint.Utils = {
	...
	initialize: function () {
		...
		this.registerLayer(L.MarkerClusterGroup, 'L.MarkerClusterGroup', function (layer, utils) {return L.markerClusterGroup(utils.cloneInnerLayers(layer)); });
		...
		this.registerLayer(L.GeoJSON, 'L.GeoJSON', function(layer) { 				return L.geoJson(layer.toGeoJSON(), layer.options); });
				...
				this.registerLayer(L.FeatureGroup.SubGroup, 'L.FeatureGroup', function(layer, utils){
